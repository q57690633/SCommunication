...
public class TopSelectionActivity extends BaseActivity implements View.OnClickListener{
    ...
    private TopSelectionDuoXuanAdapter mAdpterDuoXuan;

    private TopSelectionAdapter mAdpter;
    ...
    protected void initContentView() {
        setContentView(R.layout.activity_top_selection);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fangxin_Determine:
                ...
                updata();
                selectStick(PreferenceUtil.getString(Constanst.CITY_NAME) + ",-1,-1,-1", stringBuffer.toString(), "", "", "", "", "", "", "", "",
                        "", "", "", "0", 0, "", "", "1", "");

                break;
            case R.id.measure_Determine:
                updata();
                selectStick(PreferenceUtil.getString(Constanst.CITY_NAME) + ",-1,-1,-1", "", minAcreage, maxAcreage,
                        "", "", "", "", "", "",
                        "", "", "", "0", 0, "", "", "1", "");
                break;
            case R.id.more_Determine:
                ...
                selectStick(PreferenceUtil.getString(Constanst.CITY_NAME) + ",-1,-1,-1", "", "", "",
...
//            mRecyclerView.addItemDecoration(new SpaceItemDecoration(0, 15));
    ...
    private void selectStick(String villageName,
        ...
        showProgressDialog();
        ApiModule.getInstance().selectStick(villageName, houseType, minAcreage, maxAcreage, minPrice, maxPrice, orientation,
                ...
                .subscribe(topSelectionEntities -> {
                    if (topSelectionEntities != null) {
                        KyLog.object(topSelectionEntities + "");
                        setData(topSelectionEntities);
                        setDuoXuanData(topSelectionEntities);
                    }
