...
public class DataBaseTravelDetiailsActivity extends BaseActivity implements View.OnClickListener, ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void initContentView() {
        setContentView(R.layout.activity_data_base_travel_detiails);
...
//        travel = PreferenceUtil.getString(Constanst.TAB_NMAE_TRAFFIC);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: // 直接调起相机
                        ...
                        Intent intent = new Intent(DataBaseTravelDetiailsActivity.this, ImageGridActivity.class);
                    ...
                    case 1:
                        //打开选择,本次允许选择的数量
                        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                        Intent intent1 = new Intent(DataBaseTravelDetiailsActivity.this, ImageGridActivity.class);
    ...
    private void uploadImage(ArrayList<ImageItem> pathList) {
        ...
        httpUtil.postFileRequest(url, map, pathList, new MyStringCallBack() {
            ...
            public void onError(Call call, Exception e, int id) {
                ...
                KyLog.d("release === " + e);
                Toast.makeText(DataBaseTravelDetiailsActivity.this, "发布失败", Toast.LENGTH_SHORT).show();
                cancelProgressDialog();
            }
            ...
            public void onResponse(String response, int id) {
                ...
                Toast.makeText(DataBaseTravelDetiailsActivity.this, "发布成功", Toast.LENGTH_SHORT).show();
                if (TextUtils.isEmpty(type)) {
                    Intent intent = new Intent(DataBaseTravelDetiailsActivity.this, MainActivity.class);
                    startActivity(intent);
                } else {
                    try {
