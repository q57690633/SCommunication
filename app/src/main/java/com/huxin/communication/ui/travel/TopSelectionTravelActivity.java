...
import com.huxin.communication.adpter.TopSelectionJingWaiAdapter;
import com.huxin.communication.adpter.TopSelectionTicketAdapter;
import com.huxin.communication.adpter.TopSelectionTravelAdapter;
import com.huxin.communication.adpter.TopSelectionTravelDuoXuanAdapter;
import com.huxin.communication.adpter.TopSelectionTravelJingWaiDuoXuanAdapter;
import com.huxin.communication.adpter.TopSelectionTravelTicketDuoXuanAdapter;
...
public class TopSelectionTravelActivity extends BaseActivity implements View.OnClickListener{
    ...
    private TopSelectionJingWaiAdapter mWaiAdapter;
    private TopSelectionTravelAdapter mAdpter;
    private TopSelectionTicketAdapter mTicketAdapter;

    private TopSelectionTravelDuoXuanAdapter mTopSelectionTravelDuoXuanAdapter;
    private TopSelectionTravelJingWaiDuoXuanAdapter mTopSelectionTravelJingWaiDuoXuanAdapter;
    private TopSelectionTravelTicketDuoXuanAdapter mTopSelectionTravelTicketDuoXuanAdapter;
    ...
    protected void initContentView() {
        setContentView(R.layout.activity_top_selection2);
    ...
    private void setData(AroundStickEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            LinearLayoutManager manager = new LinearLayoutManager(this);
            mAdpter = new TopSelectionTravelAdapter(entity.getList(), this);
    ...
    private void setDuoXuanData(AroundStickEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            LinearLayoutManager manager = new LinearLayoutManager(this);
            mTopSelectionTravelDuoXuanAdapter = new TopSelectionTravelDuoXuanAdapter(entity.getList(), this);
            mRecyclerViewDuoXuan.setAdapter(mTopSelectionTravelDuoXuanAdapter);
    ...
    private void setJingWaiDuoXuanData(ForeignStickEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            LinearLayoutManager manager = new LinearLayoutManager(this);
            mTopSelectionTravelJingWaiDuoXuanAdapter = new TopSelectionTravelJingWaiDuoXuanAdapter(entity.getList(), this);
            mRecyclerViewDuoXuan.setAdapter(mTopSelectionTravelJingWaiDuoXuanAdapter);
            mRecyclerViewDuoXuan.setLayoutManager(manager);
            mRecyclerViewDuoXuan.addItemDecoration(new SpaceItemDecoration(0, 15));
            mTextViewGuanLi.setVisibility(View.VISIBLE);
        }
    ...
    private void setTicketDuoXuanData(TicketStickEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            LinearLayoutManager manager = new LinearLayoutManager(this);
            mTopSelectionTravelTicketDuoXuanAdapter = new TopSelectionTravelTicketDuoXuanAdapter(entity.getList(), this);
            mRecyclerViewDuoXuan.setAdapter(mTopSelectionTravelTicketDuoXuanAdapter);
            mRecyclerViewDuoXuan.setLayoutManager(manager);
            mRecyclerViewDuoXuan.addItemDecoration(new SpaceItemDecoration(0, 15));
            mTextViewGuanLi.setVisibility(View.VISIBLE);
        }
    ...
    private void setJingWaiData(ForeignStickEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            LinearLayoutManager manager = new LinearLayoutManager(this);
            mWaiAdapter = new TopSelectionJingWaiAdapter(entity.getList(), this);
    ...
    private void setTicketData(TicketStickEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            LinearLayoutManager manager = new LinearLayoutManager(this);
            mTicketAdapter = new TopSelectionTicketAdapter(entity.getList(), this);
     ...
     * 国内和周边
     */
    private void selectAroundStick() {
        showProgressDialog();
        ApiModule.getInstance().selectAroundStick("", "", "", "", "", "", "", "", "", "",
                "", "", "1", "", "",null)
                .subscribe(aroundStickEntity -> {
                    cancelProgressDialog();
                    KyLog.object(aroundStickEntity);
                    setData(aroundStickEntity);
                    setDuoXuanData(aroundStickEntity);
     ...
     * 境外
     */
    private void selectForeignStick() {
        showProgressDialog();
        ApiModule.getInstance().selectForeignStick("", "", "", "", "", "", "", "", "", "",
                "", "", "", "", "", "", "1",null)
                .subscribe(foreignStickEntity -> {
                    cancelProgressDialog();
                    KyLog.object(foreignStickEntity);
                    setJingWaiData(foreignStickEntity);
                    setJingWaiDuoXuanData(foreignStickEntity);
     ...
     * 票务
     */
    private void selectTicketStick() {
        showProgressDialog();
        ApiModule.getInstance().selectTicketStick("", "", "", "",
                "", "", "", "", "1",null)
                .subscribe(ticketStickEntity -> {
                    cancelProgressDialog();
                    KyLog.object(ticketStickEntity);
                    setTicketData(ticketStickEntity);
                    setTicketDuoXuanData(ticketStickEntity);
