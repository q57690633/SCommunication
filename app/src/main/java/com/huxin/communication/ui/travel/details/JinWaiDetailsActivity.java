...
public class JinWaiDetailsActivity extends BaseActivity {
    ...
    private void setData(ForeignTravelEntity entity) {
        if (entity.getList() != null && entity.getList().size() > 0) {
            ...
            mTextViewNumberDays.setText(entity.getList().get(position).getNumber_days());
            mTextViewTotalPrice.setText(entity.getList().get(position).getTotal_price());
            mTextViewReturnPrice.setText(entity.getList().get(position).getReturn_price());
            mTextViewTotalPriceChild.setText(entity.getList().get(position).getTotal_price_child());
