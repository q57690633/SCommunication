...
public class GuoNeiYouUnit extends MessageOperaUnit implements View.OnClickListener{
    ...
    public GuoNeiYouUnit() {
        iconResId = R.drawable.tab_icon_guoneiyou;
        titleId = R.string.title_tab_icon_guoneiyou;
