...
public class PiaoWuUnit extends MessageOperaUnit implements View.OnClickListener{
    ...
    public PiaoWuUnit() {
        iconResId = R.drawable.tab_icon_piowu;
        titleId = R.string.title_tab_icon_piaowu;
