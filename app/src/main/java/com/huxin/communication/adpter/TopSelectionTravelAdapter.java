...
public class TopSelectionTravelAdapter extends RecyclerView.Adapter<TopSelectionTravelAdapter.MyViewHoder>{
    private List<AroundStickEntity.ListBean> list;
    private Context mContext;
    private LayoutInflater mInflater;
    private TableNameAdapter mAdapterTableName;

    public TopSelectionTravelAdapter(List<AroundStickEntity.ListBean> list, Context mContext) {
        this.list = list;
