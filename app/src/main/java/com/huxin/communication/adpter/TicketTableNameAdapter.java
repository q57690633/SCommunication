...
public class TicketTableNameAdapter extends RecyclerView.Adapter<TicketTableNameAdapter.MyViewHoder> {

    private List<String> list;
    private Context mContext;
    private LayoutInflater mInflater;

    public TicketTableNameAdapter(List<String> list, Context mContext) {
        this.list = list;
