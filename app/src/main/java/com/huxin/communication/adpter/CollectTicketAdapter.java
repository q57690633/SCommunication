...
public class CollectTicketAdapter extends RecyclerView.Adapter<CollectTicketAdapter.MyViewHoder>{
    private List<CollectTicketEntity.ListBean> list;
    private Context mContext;
    private LayoutInflater mInflater;
    private TableNameAdapter mAdapterTableName;

    public CollectTicketAdapter(List<CollectTicketEntity.ListBean> list, Context mContext) {
        this.list = list;
...
//        holder.mTextViewNumberDays.setText("行程天数：" + list.get(position).getNumber_days() + "天");
        holder.mTextViewTotalPrice.setText("成人：" + list.get(position).getOriginal_price() + "元");
