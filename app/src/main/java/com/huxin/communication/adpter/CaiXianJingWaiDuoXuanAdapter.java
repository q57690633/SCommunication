...
public class CaiXianJingWaiDuoXuanAdapter extends RecyclerView.Adapter<CaiXianJingWaiDuoXuanAdapter.MyViewHoder>{
    ...
    public CaiXianJingWaiDuoXuanAdapter(List<CollectAroundEntity.ListBean> list, Context mContext) {
        this.list = list;
