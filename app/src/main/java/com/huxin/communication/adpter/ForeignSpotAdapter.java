...
public class ForeignSpotAdapter extends RecyclerView.Adapter<ForeignSpotAdapter.BodyViewHoder>{

    private Activity mActivity;
    private List<ForeignSpotEntity> mList;
    private LayoutInflater mInflater;

    public ForeignSpotAdapter(List<ForeignSpotEntity> mList, Activity mActivity) {
        this.mList = mList;
    ...
    public BodyViewHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Hoder.mRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PreferenceUtil.putString(Constanst.SPOT_NATION_NAME,mList.get(Hoder.getAdapterPosition()).getSpot_name());
//                PreferenceUtil.putString(Constanst.SPOT_ID,String.valueOf(mList.get(Hoder.getAdapterPosition()).getId()));
                mActivity.finish();
            }
        });
        return Hoder;
