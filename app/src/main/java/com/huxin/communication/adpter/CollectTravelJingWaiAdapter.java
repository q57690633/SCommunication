...
public class CollectTravelJingWaiAdapter extends RecyclerView.Adapter<CollectTravelJingWaiAdapter.MyViewHoder>{

    private List<CollectForeignEntity.ListBean> list;
    private Context mContext;
    private LayoutInflater mInflater;
    private TableNameAdapter mAdapterTableName;

    public CollectTravelJingWaiAdapter(List<CollectForeignEntity.ListBean> list, Context mContext) {
        this.list = list;
...
//        });
    ...
    private void setTextView(List<CollectForeignEntity.ListBean> list, int position, RecyclerView linearLayout) {
