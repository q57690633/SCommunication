...
public class CollectTravelDuoXuanAdapter extends RecyclerView.Adapter<CollectTravelDuoXuanAdapter.MyViewHoder>{
    ...
    public CollectTravelDuoXuanAdapter(List<CollectAroundEntity.ListBean> list, Context mContext) {
        this.list = list;
