...
public class QiuZuSearchAdapter extends RecyclerView.Adapter<QiuZuSearchAdapter.MyViewHoder>{
    ...
    public QiuZuSearchAdapter(List<SelectFrameEntity> list, Context mContext) {
        this.list = list;
