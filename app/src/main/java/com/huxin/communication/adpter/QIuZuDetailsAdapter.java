...
public class QIuZuDetailsAdapter extends RecyclerView.Adapter<QIuZuDetailsAdapter.MyViewHoder>{

    private List<String> list;
    private Context mContext;
    private LayoutInflater mInflater;

    public QIuZuDetailsAdapter(List<String> list, Context mContext) {
        this.list = list;
