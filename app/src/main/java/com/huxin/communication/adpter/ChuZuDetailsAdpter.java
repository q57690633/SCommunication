...
public class ChuZuDetailsAdpter extends RecyclerView.Adapter<ChuZuDetailsAdpter.MyViewHoder>{

    private List<String> list;
    private Context mContext;
    private LayoutInflater mInflater;

    public ChuZuDetailsAdpter(List<String> list, Context mContext) {
        this.list = list;
