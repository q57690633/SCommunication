...
public class QiuZuDuoXuanAdapter extends RecyclerView.Adapter<QiuZuDuoXuanAdapter.MyViewHoder>{
    ...
    //更新adpter的数据和选择状态
    public void updateDataSet(ArrayList<WantedScreeningEntity.ListBean> list) {
        this.list = list;
...
//        ab.setTitle("已选择" + 0 + "项");
    ...
    //获得选中条目的结果
    public ArrayList<WantedScreeningEntity.ListBean> getSelectedItem() {
        ArrayList<WantedScreeningEntity.ListBean> selectList = new ArrayList<>();
    ...
    public QiuZuDuoXuanAdapter(List<WantedScreeningEntity.ListBean> list, Context mContext) {
        this.list = list;
