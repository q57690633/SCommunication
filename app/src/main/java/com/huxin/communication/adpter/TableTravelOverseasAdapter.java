...
public class TableTravelOverseasAdapter extends RecyclerView.Adapter<TableTravelOverseasAdapter.MyViewHoder>{
    private List<TabTravelNameEntity.OverseaslistBean> list;
    private Context mContext;
    private LayoutInflater mInflater;

    public TableTravelOverseasAdapter(List<TabTravelNameEntity.OverseaslistBean> list, Context mContext) {
        this.list = list;
