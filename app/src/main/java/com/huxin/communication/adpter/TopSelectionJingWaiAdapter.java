...
public class TopSelectionJingWaiAdapter extends RecyclerView.Adapter<TopSelectionJingWaiAdapter.MyViewHoder>{
    ...
    public TopSelectionJingWaiAdapter(List<ForeignStickEntity.ListBean> list, Context mContext) {
        this.list = list;
