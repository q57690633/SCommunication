...
public class ChuZuAdapter extends RecyclerView.Adapter<ChuZuAdapter.MyViewHoder> {
    ...
    public ChuZuAdapter(List<RentalScreeningEntity.ListBean> list, Context mContext) {
        this.list = list;
