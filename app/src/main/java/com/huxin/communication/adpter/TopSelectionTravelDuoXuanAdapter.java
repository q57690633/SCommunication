...
public class TopSelectionTravelDuoXuanAdapter extends RecyclerView.Adapter<TopSelectionTravelDuoXuanAdapter.MyViewHoder>{

    private List<AroundStickEntity.ListBean> list;
    private Context mContext;
    private LayoutInflater mInflater;
    private TableNameAdapter mAdapterTableName;

    public TopSelectionTravelDuoXuanAdapter(List<AroundStickEntity.ListBean> list, Context mContext) {
        this.list = list;
...
//        });
    ...
    private void setTextView(List<AroundStickEntity.ListBean> list, int position, RecyclerView linearLayout) {
