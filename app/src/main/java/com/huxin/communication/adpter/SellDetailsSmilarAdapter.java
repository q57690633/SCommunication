...
public class SellDetailsSmilarAdapter  extends RecyclerView.Adapter<SellDetailsSmilarAdapter.MyViewHoder>{
    private List<String> list;
    private Context mContext;
    private LayoutInflater mInflater;

    public SellDetailsSmilarAdapter(List<String> list, Context mContext) {
        this.list = list;
